...
DOC_TEMPLATES = {
    "01-project-background.md": "# 项目背景\n\n`Stage: Draft` `Priority: P0` `Release: MVP` `Status: Need Review`\n\n> **一句话产品定义：** 待补充\n>\n> **Why now：** 待补充\n>\n> **这次不做什么：** 待补充\n\n> **本页结论：** 待补充\n>\n> **需要谁拍板：** 待补充\n\n## 发起背景\n\n## 行业 / 业务环境\n\n## 现状与机会窗口\n\n## 为什么是现在\n\n## 不做的代价\n\n## 决策者速览\n\n| 维度 | 结论 |\n| --- | --- |\n| 用户价值 | 待补充 |\n| 商业价值 | 待补充 |\n| 核心下注 | 待补充 |\n| 关键取舍 | 待补充 |\n\n## 外部驱动因素\n\n| 维度 | 变化 | 对项目的影响 | 备注 |\n| --- | --- | --- | --- |\n| 市场 | 待补充 | 待补充 | 待补充 |\n| 业务 | 待补充 | 待补充 | 待补充 |\n| 组织 | 待补充 | 待补充 | 待补充 |\n\n## 参考图片 / 市场信号\n\n![市场或竞品参考图](./assets/project-background-reference.png)\n\n*说明：这张图展示什么、支持什么判断、为什么与本项目相关。*\n\n## 下一步动作\n\n- [ ] 补齐市场证据\n- [ ] 确认业务优先级\n- [ ] 明确项目发起边界\n\n",
    "02-executive-summary.md": "# 执行摘要\n\n> 默认使用飞书可编辑格式。不要把本页核心图形做成 SVG 或静态图片。\n\n`Audience: 管理层` `Read time: 3 min` `Priority: P0` `Need Decision`\n\n> **本页结论：** 当前建议推进待补充作为本期主方案。\n>\n> **待确认：** 最终范围、资源投入、上线窗口待补充。\n\n## 项目概述\n\n## 为什么现在做\n\n## 本期交付范围\n\n## 预期业务结果\n\n## 封面型总览图\n\n```mermaid\nmindmap\n  root((产品总览))\n    用户价值\n      待补充\n    核心流程\n      待补充\n    商业结果\n      待补充\n```\n\n## 体验旅程图\n\n```mermaid\njourney\n    title 待补充\n    section 发现\n      用户进入场景: 3: 用户\n    section 完成任务\n      用户完成关键动作: 4: 用户, 产品\n    section 得到反馈\n      用户获得结果与下一步: 5: 产品\n```\n\n## 本期重点卡片\n\n| 模块 | 要解决的问题 | 价值 |\n| --- | --- | --- |\n| 待补充 | 待补充 | 待补充 |\n\n## 评审看板\n\n| Block | Key message | Why it matters | Owner |\n| --- | --- | --- | --- |\n| Decision | 待补充 | 待补充 | 待补充 |\n| Risk | 待补充 | 待补充 | 待补充 |\n| Dependency | 待补充 | 待补充 | 待补充 |\n\n## 管理层决策清单\n\n| 议题 | 推荐意见 | 不决策的影响 | 截止时间 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 配图 / 截图位\n\n![封面辅助图](./assets/executive-summary-cover.png)\n\n*说明：本图用于帮助读者快速建立场景感，不替代可编辑结构图。*\n\n## 下一步动作\n\n- [ ] 组织评审会\n- [ ] 锁定 MVP 范围\n- [ ] 明确 Owner 与时间点\n\n",
    "03-problem-and-goals.md": "# 问题与目标\n\n`Problem Framing` `Goal Alignment` `Success Criteria`\n\n> **本页结论：** 当前最值得解决的问题是待补充。\n>\n> **待确认：** 指标基线、目标时间窗、核心权衡待补充。\n\n## 当前核心问题\n\n## 问题根因拆解\n\n1. 待补充\n2. 待补充\n3. 待补充\n\n## 目标\n\n## 非目标\n\n## 成功指标\n\n| 指标 | 当前值 | 目标值 | 时间窗 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## Focus / Say No\n\n- 要坚持做的：待补充\n- 本期明确不做的：待补充\n- 容易分散焦点的诱惑项：待补充\n\n## 影响范围\n\n| 角色 / 团队 | 影响内容 | 严重程度 | 备注 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 下一步动作\n\n- [ ] 补齐基线数据\n- [ ] 确认目标优先级\n- [ ] 锁定非目标边界\n\n",
    "04-user-segments-and-scenarios.md": "# 用户角色与场景\n\n`User Research` `Primary Persona` `Scenario Map`\n\n> **本页结论：** 当前优先服务的核心角色是待补充。\n>\n> **待确认：** 核心角色优先级、频次最高场景、最痛点任务仍需补充。\n\n## 核心角色\n\n## 次级角色\n\n## 角色摘要表\n\n| 角色 | 核心目标 | 主要任务 | 关键痛点 | 使用频次 |\n| --- | --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 典型使用场景\n\n## 高频任务\n\n## 关键痛点\n\n## 场景优先级矩阵\n\n| 场景 | 触发频次 | 商业价值 | 体验风险 | 优先级 |\n| --- | --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 | P0 |\n\n## 用户旅程备注\n\n- 场景 A：待补充\n- 场景 B：待补充\n- 场景 C：待补充\n\n",
    "05-solution-overview.md": "# 方案总览\n\n`Scope: Core Solution` `Release: MVP+V1` `Review: Product/Design/Tech`\n\n> **本页结论：** 当前建议采用待补充作为主方案路径。\n>\n> **待确认：** 关键模块优先级、设计复杂度、技术约束待补充。\n\n## 方案摘要\n\n## 用户价值\n\n## 平台价值\n\n## 体验原则\n\n1. 待补充\n2. 待补充\n3. 待补充\n\n## 产品循环图\n\n```mermaid\nflowchart LR\n    A[\"触发\"] --> B[\"激活\"]\n    B --> C[\"获得价值\"]\n    C --> D[\"留存 / 复用\"]\n    D --> E[\"传播 / 扩张\"]\n    E --> A\n```\n\n## 方案结构图\n\n```mermaid\nflowchart TB\n    A[\"用户入口\"] --> B[\"核心体验层\"]\n    B --> C[\"关键工作流\"]\n    C --> D[\"支撑能力\"]\n    D --> E[\"反馈与增长\"]\n```\n\n## 模块清单\n\n| 模块 | 目标 | 主要用户 | 优先级 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | P0 |\n\n## 方案对比矩阵\n\n| 选项 | 优势 | 劣势 | 结论 |\n| --- | --- | --- | --- |\n| 方案 A | 待补充 | 待补充 | 待补充 |\n| 方案 B | 待补充 | 待补充 | 待补充 |\n\n## 关键设计决策\n\n| 议题 | 决策方向 | 原因 | 影响范围 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 配图 / 参考图位\n\n![方案参考图](./assets/solution-overview-reference.png)\n\n*说明：这里可以放竞品截图、白板草图、页面草模，下面必须写结论。*\n\n## 范围边界\n\n### In Scope\n\n### Out of Scope\n\n### Later\n\n## 下一步动作\n\n- [ ] 锁定方案主路径\n- [ ] 补齐关键模块说明\n- [ ] 确认跨团队依赖\n\n",
    "06-user-flows.md": """# 用户流程
...
""",
    "07-functional-requirements.md": "# 功能需求\n\n`Functional Scope` `Requirement Detail` `Priority`\n\n> **本页结论：** 当前版本的核心能力范围是待补充。\n>\n> **待确认：** P0 / P1 划分、依赖前置条件、异常路径需求待补充。\n\n## 模块总表\n\n| 模块 | 关键能力 | 用户价值 | 优先级 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | P0 |\n\n## 用户端\n\n## 任务方端\n\n## 高校管理端\n\n## 运营后台\n\n## 需求明细表\n\n| 编号 | 模块 | 需求描述 | 验收口径 | 优先级 | Owner |\n| --- | --- | --- | --- | --- | --- |\n| FR-01 | 待补充 | 待补充 | 待补充 | P0 | 待补充 |\n\n## 依赖与约束\n\n- 待补充\n\n## 优先级\n\n",
    "08-business-rules-and-acceptance.md": "# 业务规则与验收\n\n`Business Rules` `Access Control` `Acceptance`\n\n> **本页结论：** 当前业务规则的核心约束是待补充。\n>\n> **待确认：** 特殊审批、回退逻辑、权限边界待补充。\n\n## 核心业务规则\n\n## 状态流转规则\n\n## 权限规则\n\n## 规则清单表\n\n| 规则编号 | 规则描述 | 触发条件 | 系统处理 | 例外情况 |\n| --- | --- | --- | --- | --- |\n| BR-01 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 验收标准\n\n## 边界与异常处理\n\n## 验收检查表\n\n| 验收项 | 通过标准 | 验证方式 | Owner |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n",
    "09-information-architecture.md": """# 功能架构
...
`Tech Review` `Service Boundary` `Risk Check`
...
![技术方案草图或现网架构截图](./assets/technical-architecture-reference.png)

*说明：这张图用于补充上下文，不替代上方可编辑架构图。*

""",
    "11-metrics-risks-dependencies.md": "# 指标、风险、依赖\n\n`Metrics` `Risk` `Dependencies` `Go/No-Go`\n\n## 北极星指标\n\n## 过程指标\n\n## 指标漏斗图\n\n| 漏斗阶段 | 定义 | 当前值 | 目标值 | Owner |\n| --- | --- | --- | --- | --- |\n| 曝光 / 触达 | 待补充 | 待补充 | 待补充 | 待补充 |\n| 访问 / 激活 | 待补充 | 待补充 | 待补充 | 待补充 |\n| 核心行为完成 | 待补充 | 待补充 | 待补充 | 待补充 |\n| 留存 / 复购 / 复用 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 风险清单\n\n| 风险 | 概率 | 影响 | 缓解方式 |\n| --- | --- | --- | --- |\n| 待补充 | 中 | 高 | 待补充 |\n\n## 风险热力表\n\n| 影响 \\ 概率 | 低 | 中 | 高 |\n| --- | --- | --- | --- |\n| 高 | [ ] | [ ] | [风险] |\n| 中 | [ ] | [风险] | [ ] |\n| 低 | [ ] | [ ] | [ ] |\n\n## 外部依赖\n\n| 依赖 | Owner | 状态 | 延误影响 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 假设\n\n## 数据看板截图位\n\n![指标看板或埋点分析图](./assets/metrics-dashboard-reference.png)\n\n*说明：说明这张图是什么、关键观察是什么、接下来会怎么用。*\n\n",
    "13-interaction-and-content-spec.md": "# 交互与内容规范\n\n`UX Spec` `Copy Spec` `State Design`\n\n## 核心交互原则\n\n1. 待补充\n2. 待补充\n3. 待补充\n\n## 页面级交互说明\n\n| 页面 / 模块 | 关键操作 | 反馈机制 | 异常处理 | 文案要点 |\n| --- | --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 状态与提示文案\n\n| 状态 | 触发条件 | 标题文案 | 辅助文案 | 操作按钮 |\n| --- | --- | --- | --- | --- |\n| 空态 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 空态 / 错误态 / 无权限态\n\n## 交互参考图位\n\n![交互草图或页面截图](./assets/interaction-spec-reference.png)\n\n*说明：这里说明页面的交互重点，不要只贴图。*\n\n",
    "15-launch-and-operations.md": "# 上线与运营方案\n\n`Launch Plan` `Ops` `Enablement`\n\n## 上线前准备\n\n## 灰度 / 放量策略\n\n## 客服与运营预案\n\n## 培训与对内同步\n\n## 上线后观察清单\n\n| 阶段 | 关注指标 | 风险信号 | 响应动作 |\n| --- | --- | --- | --- |\n| 上线当日 | 待补充 | 待补充 | 待补充 |\n| 上线后 7 天 | 待补充 | 待补充 | 待补充 |\n\n## 上线节奏泳道\n\n| 时间段 | 产品 | 研发 | 测试 | 运营 | 客服 |\n| --- | --- | --- | --- | --- | --- |\n| T-7 ~ T-1 | 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n| T Day | 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n| T+1 ~ T+7 | 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n",
    "12-scope-and-release-plan.md": "# 范围与版本规划\n\n`Scope Planning` `Release Strategy` `Phasing`\n\n> **本页结论：** 当前建议先以待补充为 MVP 交付。\n>\n> **待确认：** 放量节奏、版本边界、资源投入待补充。\n\n## 版本切分原则\n\n## MVP 范围\n\n## V1 增强项\n\n## 后续版本 Backlog\n\n## 版本对比表\n\n| 版本 | 核心能力 | 不包含内容 | 目标用户 | 成功条件 |\n| --- | --- | --- | --- | --- |\n| MVP | 待补充 | 待补充 | 待补充 | 待补充 |\n| V1 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 发布策略\n\n| 版本 | 范围 | 目标用户 | 上线条件 |\n| --- | --- | --- | --- |\n| MVP | 待补充 | 待补充 | 待补充 |\n| V1 | 待补充 | 待补充 | 待补充 |\n\n",
    "14-data-and-analytics.md": "# 数据与分析设计\n\n`Data Design` `Analytics` `Tracking`\n\n> **本页结论：** 当前最关键的数据观察链路是待补充。\n>\n> **待确认：** 事件命名规范、属性口径、看板 Owner 待补充。\n\n## 关键数据对象\n\n## 埋点目标\n\n## 事件清单\n\n| 事件名 | 触发时机 | 属性 | 指标归属 | Owner |\n| --- | --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 指标口径表\n\n| 指标 | 定义 | 计算方式 | 数据源 | 更新频率 |\n| --- | --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 数据口径说明\n\n## 看板建议\n\n## 数据质量风险\n\n- 待补充\n\n",
    "16-milestones.md": "# 里程碑\n\n`Milestone Plan` `Cross-team Timeline` `Delivery`\n\n> **本页结论：** 当前关键路径为待补充。\n>\n> **待确认：** 依赖方时间承诺、上线窗口、缓冲策略待补充。\n\n## 阶段划分\n\n## 每阶段交付物\n\n## 里程碑表\n\n| 阶段 | 时间范围 | 关键产出 | 负责人 | 风险 |\n| --- | --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 风险缓冲\n\n## 关键路径说明\n\n- 待补充\n\n",
    "17-open-questions-and-decisions.md": "# 开放问题与关键决策\n\n`Decision Log` `Open Questions` `Alignment`\n\n> **本页结论：** 当前最需要优先拍板的问题是待补充。\n>\n> **待确认：** 决策截止时间、决策 Owner、争议方案待补充。\n\n## 已确认决策\n\n| 主题 | 决策 | 原因 | 影响范围 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 待确认问题\n\n| 问题 | Owner | 需要确认时间 | 风险 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 争议点对比\n\n| 议题 | 方案 A | 方案 B | 推荐意见 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n",
    "18-appendix-and-assets.md": "# 附录与素材索引\n\n`Appendix` `References` `Assets`\n\n> **本页结论：** 当前支持本 PRD 的材料索引需集中沉淀在此。\n>\n> **待确认：** 外部链接有效性、附件归档路径、引用来源完整性待补充。\n\n## 关联文档\n\n- 待补充\n\n## 参考资料\n\n- 待补充\n\n## 术语说明\n\n| 术语 | 定义 | 备注 |\n| --- | --- | --- |\n| 待补充 | 待补充 | 待补充 |\n\n## 素材索引\n\n| 类型 | 路径 / 链接 | 用途 | 备注 |\n| --- | --- | --- | --- |\n| 待补充 | 待补充 | 待补充 | 待补充 |\n\n## 引用与证据备注\n\n- 待补充\n\n",
}
